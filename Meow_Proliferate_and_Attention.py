...
from Meow_Attention import Meow_Attention_Block
from Meow_Proliferate import Meow_Proliferate_Block

class Self_Proliferate_and_Attention_Block(Layer):

    def __init__(self, dwkernel, strides, exp, out, ratio, use_se):
        super(Meow_Proliferate_and_Attention_Block, self).__init__()
        ...
        self.SAB1 = Meow_Proliferate_Block(exp, ratio, 1, 3)
        self.SAB2 = Meow_Proliferate_Block(out, ratio, 1, 3)
        self.se = Meow_Attention_Block(exp, ratio)
